...
public partial class ProductComparingDBContext : DbContext
{
    public ProductComparingDBContext()
    {
    }

    public ProductComparingDBContext(DbContextOptions<ProductComparingDBContext> options)
        : base(options)
    {
    }
